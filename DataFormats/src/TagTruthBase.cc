...
void TagTruthBase::setHTXSInfo( int stage0cat, int stage1cat, int stage1_1_cat, int stage1_1_fine_cat, int njets, float pTH, float pTV ) {
...
void TagTruthBase::copyBaseInfo( const TagTruthBase &b ) {
    setGenPV( b.genPV() );
    setHTXSInfo( b.HTXSstage0cat(), b.HTXSstage1cat(), b.HTXSstage1_1_cat(), b.HTXSstage1_1_fine_cat(), b.HTXSnjets(), b.HTXSpTH(), b.HTXSpTV() );
}
